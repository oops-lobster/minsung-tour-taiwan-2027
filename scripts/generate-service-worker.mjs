...
const shellAssets = [...new Set(['./', './index.html', './offline.html', './manifest.webmanifest', './icon-192.png', './icon-512.png', ...entryAssets])]
  ...
  event.respondWith((async () => {
    ...
    try {
      ...
      if (event.request.mode === 'navigate') {
        return (await caches.match(scopedUrl('./index.html'))) ?? (await caches.match(scopedUrl('./offline.html')))
      }
